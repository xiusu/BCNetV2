...
def build_optimizer(opt, model, lr, eps=1e-10, momentum=0.9, weight_decay=1e-5, filter_bias_and_bn=True, nesterov=True):
...
def _add_weight_decay(model, lr, weight_decay=1e-5, skip_list=()):
    decay = []
    no_decay = []
